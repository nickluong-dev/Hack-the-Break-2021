...
AVAILABLE_CLASSES = {"\U00002694": character_classes.Warrior,
...
class user_controller(commands.Cog):
    ...
    async def start(self, ctx):
        ...
        em.add_field(name="Warrior", value="\U00002694")
    ...
    async def on_raw_reaction_add(self, payload):
        ...
        if (payload.user_id, payload.message_id) not in user_reacted and payload.user_id != 820355672587108422:
            user_reacted.add((payload.user_id, payload.message_id))
